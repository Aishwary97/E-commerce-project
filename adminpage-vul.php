...
<style>
	...
	<body>
		...
		<script>
		  ...
		  setupform("fileform", "FileUpload_vulnerable.php", "fileoutput");
		});
		</script>
		<!-- HTML Part-->	
		<div>
			...
			<p>
			Please submit photes of you enjoying our products and we will post them
			for everyone to see!!
			<br>
			...
			<div class="body_padded">
				<div class="vulnerable_code_area">
					<form id = "fileform" action="FileUpload_vulnerable.php" method="post" enctype="multipart/form-data">
		...
		<button onClick="viewLog()">Are you an Admin? Click here to show activity logs.</button>
		<script>
			function viewLog(){
